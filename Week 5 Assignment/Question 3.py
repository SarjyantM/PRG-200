class DeliveryPartner:
    ...
    def display(self):
        print(f"{self.name} ({self.partner_id}) | Deliveries: {self.deliveries} | Earning: NPR {self.total_earning()}")
...
print(f"\nHighest earner: {top_partner.name} with NPR {top_partner.total_earning()}")